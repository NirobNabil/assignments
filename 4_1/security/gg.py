...
while True:
	commands = []
	my_money, my_lives, opponent_money, opponent_lives, tower_count, towers, attackers = process_input()
		...
		for y in range(height):
			for x in range(width):
				if x+1 < width and get_coordinate(x, y) == '#' and get_coordinate(x+1, y) == '.' and not check_if_block_is_occupied(x,y,towers):
					if my_money > 100:
						build_tower(x, y, "FIRETOWER") # you can change this to GUNTOWER, FIRETOWER, GLUETOWER or HEALTOWER as necessary
